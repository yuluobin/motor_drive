...
source C:/ucos_ex2017/ucos_ex2017.sdk/system_wrapper_hw_platform_0/ps7_init.tcl
...
fpga -file C:/ucos_ex2017/ucos_ex2017.sdk/system_wrapper_hw_platform_0/system_wrapper.bit
targets -set -nocase -filter {name =~"APU*" && jtag_cable_name =~ "Digilent JTAG-HS1 210512180081"} -index 0
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent JTAG-HS1 210512180081"} -index 0
dow C:/ucos_ex2017/ucos_ex2017.sdk/third_wind/Debug/third_wind.elf
bpadd -addr &main
